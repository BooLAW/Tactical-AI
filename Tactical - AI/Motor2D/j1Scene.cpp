...
bool j1Scene::Start()
{
	...
	enemy1 = (App->entitymanager->CreateEntity(enemy, debug_tex, Bush_Rect, App->map->MapToWorld(20,10)));
...
bool j1Scene::Update(float dt)
{
	...
	App->render->Blit(debug_tex, enemy1->pos.x, enemy1->pos.y, &enemy1->rect);
	// Debug pathfinding ------------------------------
	int x, y;
	App->input->GetMousePosition(x, y);
